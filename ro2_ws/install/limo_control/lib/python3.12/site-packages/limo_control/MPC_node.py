...
# |_____|_| |_|_|\__|_|\__,_|_|_/___\__,_|\__|_|\___/|_| |_|                                                          
    ...
    def __init__(self, x_init):
        ...
        self.N = self.declare_parameter('N', 0).value  # time horizon MPC
        self.N_sim = self.declare_parameter('N_sim', 0).value # number of simulation steps
...
def main(args=None):
    ...
    sol0 = mpc.warm_start(x0, mpc.x2, mpc.x3, mpc.robot_ray, mpc.target)
    rclpy.spin(mpc)
    mpc.destroy_node()
    rclpy.shutdown()

...
#include "project_interfaces/msg/detail/state__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const project_interfaces::msg::State & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  project_interfaces::msg::State & ros_message)
{
  // Member: id
  cdr >> ros_message.id;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = project_interfaces::msg::State;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const project_interfaces::msg::State *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<project_interfaces::msg::State *>(
    untyped_ros_message);
...
{
  return &project_interfaces::msg::typesupport_fastrtps_cpp::_State__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, project_interfaces, msg, State)() {
  return &project_interfaces::msg::typesupport_fastrtps_cpp::_State__handle;
}

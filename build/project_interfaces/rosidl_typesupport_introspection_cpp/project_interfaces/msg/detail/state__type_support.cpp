...
{
  new (message_memory) project_interfaces::msg::State(_init);
}

void State_fini_function(void * message_memory)
{
  auto typed_message = static_cast<project_interfaces::msg::State *>(message_memory);
  typed_message->~State();
}
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember State_message_member_array[4] = {
  {
    ...
    offsetof(project_interfaces::msg::State, id),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(project_interfaces::msg::State, x),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(project_interfaces::msg::State, y),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(project_interfaces::msg::State, theta),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers State_message_members = {
  ...
  "State",  // message name
  4,  // number of fields
  sizeof(project_interfaces::msg::State),
...
get_message_type_support_handle<project_interfaces::msg::State>()
{
  return &::project_interfaces::msg::rosidl_typesupport_introspection_cpp::State_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, project_interfaces, msg, State)() {
  return &::project_interfaces::msg::rosidl_typesupport_introspection_cpp::State_message_type_support_handle;
}

...
static rosidl_typesupport_introspection_c__MessageMember project_interfaces__msg__Landmark__rosidl_typesupport_introspection_c__Landmark_message_member_array[6] = {
  {
    "dim",  // name
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(project_interfaces__msg__Landmark, id_a),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(project_interfaces__msg__Landmark, id_b),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer

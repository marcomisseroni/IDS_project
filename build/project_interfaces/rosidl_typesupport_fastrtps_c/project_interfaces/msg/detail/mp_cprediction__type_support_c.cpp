...
#include "project_interfaces/msg/detail/mp_cprediction__rosidl_typesupport_fastrtps_c.h"
...
using _MPCprediction__ros_msg_type = project_interfaces__msg__MPCprediction;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const _MPCprediction__ros_msg_type * ros_message = static_cast<const _MPCprediction__ros_msg_type *>(untyped_ros_message);
  // Field name: x
  {
  ...
  void * untyped_ros_message)
{
  ...
  _MPCprediction__ros_msg_type * ros_message = static_cast<_MPCprediction__ros_msg_type *>(untyped_ros_message);
  // Field name: x
  {
    uint32_t cdrSize;
    cdr >> cdrSize;
...
size_t get_serialized_size_project_interfaces__msg__MPCprediction(
  const void * untyped_ros_message,
...
static uint32_t _MPCprediction__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_project_interfaces__msg__MPCprediction(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_project_interfaces
size_t max_serialized_size_project_interfaces__msg__MPCprediction(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = project_interfaces__msg__MPCprediction;
    is_plain =
      (
...
static size_t _MPCprediction__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_project_interfaces__msg__MPCprediction(
...
static message_type_support_callbacks_t __callbacks_MPCprediction = {
...
static rosidl_message_type_support_t _MPCprediction__type_support = {
  rosidl_typesupport_fastrtps_c__identifier,
  &__callbacks_MPCprediction,
  get_message_typesupport_handle_function,
};

const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, project_interfaces, msg, MPCprediction)() {
  return &_MPCprediction__type_support;
}

...
bool project_interfaces__msg__desired__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("project_interfaces.msg._desired.Desired", full_classname_dest, 39) == 0);
  }
  project_interfaces__msg__Desired * ros_message = _ros_message;
  {  // x0
...
{
  /* NOTE(esteve): Call constructor of Desired */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("project_interfaces.msg._desired");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "Desired");

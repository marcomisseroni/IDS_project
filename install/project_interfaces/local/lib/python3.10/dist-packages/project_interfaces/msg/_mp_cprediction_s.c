...
bool project_interfaces__msg__mp_cprediction__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("project_interfaces.msg._mp_cprediction.MPCprediction", full_classname_dest, 52) == 0);
  }
  project_interfaces__msg__MPCprediction * ros_message = _ros_message;
  {  // x
...
{
  /* NOTE(esteve): Call constructor of MPCprediction */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("project_interfaces.msg._mp_cprediction");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "MPCprediction");

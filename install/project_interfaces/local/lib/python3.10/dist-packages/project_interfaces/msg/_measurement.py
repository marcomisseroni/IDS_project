    ...
    def __import_type_support__(cls):
        try:
            ...
            logger = logging.getLogger(
                'project_interfaces.msg.Measurement')
            logger.debug(
...
class Measurement(metaclass=Metaclass_Measurement):
    ...
    def id_a(self, value):
        if __debug__:
            ...
            assert value >= -9223372036854775808 and value < 9223372036854775808, \
                "The 'id_a' field must be an integer in [-9223372036854775808, 9223372036854775807]"
        self._id_a = value
    ...
    def id_b(self, value):
        if __debug__:
            ...
            assert value >= -9223372036854775808 and value < 9223372036854775808, \
                "The 'id_b' field must be an integer in [-9223372036854775808, 9223372036854775807]"
        self._id_b = value
